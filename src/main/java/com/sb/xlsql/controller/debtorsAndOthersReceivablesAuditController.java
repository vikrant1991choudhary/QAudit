...
@Controller
public class debtorsAndOthersReceivablesAuditController {
    ...
    @GetMapping("/debtorsandothers")
    public String index() {
        //return "multipartfile/uploadform.html";
    	return "multipartfile/debtorsAndOthersReceivablesAuditCheckpoint.html";
    } 
